                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form name="form1" action="" method="post" >
                                <input type="text" name="t1" class="form-control" placeholder="Enter books Names"  >
                            ...
                            if(isset($_POST["submit1"]))
                            {
                                ...
                                while ($row = mysqli_fetch_array($res)) {
                                    ...
                                    echo "<td>";
                                    ?>
                                    <a href="delete_books.php?id=<?php echo $row["id"]; ?>" >Delete Books</a>
                                    <?php
                                    echo "</td>";
                                    echo "</tr>";
                                }
